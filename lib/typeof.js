...
function isArray(data) {
    ...
    else if((data instanceof Array)&& Array === data.constructor) return true;
    else return false;
}
...
function isJsonObject(value) {
    ...
    else  if(typeof value!=='object'||isArray(value)) return false;
    else return true;
 }

function isString(value) {
    if(isUndefined(value)) return false;
    else if(typeof(value) ==="string"&& String === value.constructor) return true;
    else return false;
}
function isNumber(value) {
    if(isUndefined(value)) return false;
    else if(typeof(value) ==="number"&& Number === value.constructor) return true;
    else return false;
}
function isDate(value) {
    if(isUndefined(value)) return false;
    if((value instanceof Date)&& Date === value.constructor) return true;
    else return false;
}
function isFunction(value) {
    if(isUndefined(value)) return false;
    else if(typeof(value) !=="function"||isArray(value)) return false;
    else return true;
}
function isBoolean(value) {
    if(isUndefined(value)) return false;
    else if(typeof(value) ==="boolean"&& Boolean === value.constructor) return true;
    else return false;
}
function isMap(ob) {
    var i = 0;
